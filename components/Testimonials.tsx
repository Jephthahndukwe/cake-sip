      ...
      <div className="container px-6 mx-auto">
        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          <button
            ...
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-6 z-10 w-12 h-12 bg-[#c8a882] hover:bg-[#b89872] text-white rounded-full flex items-center justify-center transition-colors duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
          ...
          <button
            ...
            className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-6 z-10 w-12 h-12 bg-[#c8a882] hover:bg-[#b89872] text-white rounded-full flex items-center justify-center transition-colors duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
            disabled={testimonials.length <= 1}
          ...
          <div className="overflow-hidden">
            <div
              ...
              style={{
                transform: isMobile
                  ? `translateX(calc(-${currentIndex * 100}% - ${currentIndex * 32}px))`
                  : `translateX(calc(-${currentIndex * 33.333}% - ${currentIndex * (32 / 3)}px))`
              }}
            >
